...
<html lang="es">
    <head>
        ...
        <script language="javascript" type="text/javascript" src="/jquery/MostrarReceta.js"></script>
            ...
            <div class="contenedor">
                <div class="mostrar">
                   <table>
                    ...
                    <tr>
                        <th colspan="5"><h3>Ensalada de Garbansos</h3></th>
                    </tr>
                    <tr>
                        <td class="handlee_font" id="tam_mostrar_datos" >Tiémpo de Preparación: </td>
                        <td class="roboto_font" id="tam_mostrar_datos2">1</td>
                    ...
                    <tr>
                        ...
                        <td colspan="4" class="roboto_font" id="padd">Média</td>
                    </tr>
                    <tr>
                        <td class="handlee_font" id="tam_mostrar_datos">Porciónes: </td>
                        <td class="roboto_font" id="tam_mostrar_datos2">4</td>
